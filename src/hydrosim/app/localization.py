...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "motion.title": "Motion — attitude, heave, and sounding geometry",
        "motion.question": "How do roll, pitch, yaw, and heave change vessel orientation, transducer position, and beam direction?",
        "motion.instruction": "Change one motion component at a time, then combine them and observe the instantaneous geometric consequence.",
        "motion.roll": "Roll",
        "motion.pitch": "Pitch",
        "motion.yaw": "Yaw deviation",
        "motion.heave": "Heave (+ Up)",
        "motion.observation": "Roll, pitch, and yaw rotate the vessel and beam axes; heave shifts the vessel and transducer vertically through the shared motion model.",
        "motion.boundary": "Deterministic instantaneous motion state using the existing vessel-motion and rigid-body geometry core.",
        "motion.not_shown": "Sea-state simulation, stochastic motion, latency, compensation, patch test, dynamic draft, and sensor errors are outside this first slice.",
    },
    "pt-BR": {
        ...
        "motion.title": "Movimento — atitude, heave e geometria da sondagem",
        "motion.question": "Como roll, pitch, yaw e heave alteram a orientação da embarcação, a posição do transdutor e a direção do feixe?",
        "motion.instruction": "Altere um componente de movimento por vez, depois combine-os e observe a consequência geométrica instantânea.",
        "motion.roll": "Roll",
        "motion.pitch": "Pitch",
        "motion.yaw": "Desvio de yaw",
        "motion.heave": "Heave (+ para cima)",
        "motion.observation": "Roll, pitch e yaw rotacionam os eixos da embarcação e do feixe; o heave desloca verticalmente a embarcação e o transdutor pelo modelo de movimento compartilhado.",
        "motion.boundary": "Estado determinístico e instantâneo de movimento usando o núcleo existente de movimento da embarcação e geometria de corpo rígido.",
        "motion.not_shown": "Estado do mar, movimento estocástico, latência, compensação, patch test, calado dinâmico e erros de sensores estão fora desta primeira etapa.",
    },
}
