...
export default function BottomDetectionLab({onBack}:{onBack:()=>void}) {
  ...
  const reset=()=>{setScenario('clean');setTxDelay(0.2);setSteering(0);setMethod('amplitude_peak');};
