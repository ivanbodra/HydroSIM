...
import { pedagogicalTracks, type Experience, type TrackKey } from '../src/pedagogical-plan';

const trackIcon: Record<TrackKey, typeof GraduationCap> = { didactic: GraduationCap, patch: FlaskConical, acquisition: Radar };

export default function CurriculumMapV1({ onOpenLegacy }: { onOpenLegacy: () => void }) {
